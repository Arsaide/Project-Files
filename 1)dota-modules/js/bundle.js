    ...
    class MenuCard {
        ...
        render() {
            ...
            if(this.classes.length === 0) {
                ...
                this.classes.forEach(className => element.classList.add(className));//добавляет классы которые находятся в классНейм
            }
...
// ВТОРОЙ ВАРИАНТ СОЗДАНИЯ КАРТОЧЕК. И ТОТ ЧТО ВЫШЕ И ЭТОТ МОЖНО ЮЗАТЬ
...
function timer(id, deadline) {
    ...
    function setClock(selector, endtime) {
        ...
        function updateClock() {
            ...
            days.innerHTML = getZeroToTimer(t.days);
            hours.innerHTML = getZeroToTimer(t.hours);
            minutes.innerHTML = getZeroToTimer(t.minutes);
            seconds.innerHTML = getZeroToTimer(t.seconds);
...
window.addEventListener('DOMContentLoaded', ()=> {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-10-19');
